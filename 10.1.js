...
function funcEach() {
    newReleases.forEach(element => console.log(element.id, element.title));
}
funcEach();
//---------------
let value;
...
function funcMap() {
    ...
    console.log(newReleases.map(newReleases => newReleases.id));
    console.log(newReleases.map(newReleases => newReleases.title));
}
funcMap();